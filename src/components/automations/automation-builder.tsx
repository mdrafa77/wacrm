...
const TRIGGER_OPTIONS: { value: AutomationTriggerType; label: string; hint: string }[] = [
  { value: "new_message_received", label: "Nova mensagem recebida", hint: "Qualquer mensagem recebida" },
  {
    ...
    hint: "Primeira mensagem enviada por este contato, inclusive contatos adicionados manualmente",
  },
  { value: "keyword_match", label: "Correspondência de palavra-chave", hint: "A mensagem contém palavras-chave específicas" },
  { value: "new_contact_created", label: "Novo contato criado", hint: "Quando um contato é criado automaticamente a partir de uma mensagem" },
  { value: "conversation_assigned", label: "Conversa atribuída", hint: "Quando atribuída a um atendente" },
  { value: "tag_added", label: "Etiqueta adicionada", hint: "Quando uma etiqueta é adicionada ao contato" },
...
export function AutomationBuilder({ initial }: { initial: BuilderInitial }) {
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-background">
      {/* Top bar. At sub-sm widths the "Ativa" label is hidden and the
    ...
    <div className="space-y-2">
      <div>
        ...
        <Input
          ...
          placeholder="ex.: preços, solicitar demonstração, falar com vendas"
          className="bg-muted text-foreground"
        />
      </div>
      <div>
      ...
      return (
        <FieldBlock label="Texto da mensagem">
          <Textarea
            ...
            placeholder="Olá! Agradecemos o contato…"
      ...
      return (
        <>
          <FieldBlock label="Mode">
            ...
            >
              <option value="round_robin">Distribuição alternada</option>
