...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  ...
  },
  {
    id: "cobalt",
    name: "Cobalto",
    tagline: "Azul B2B limpo, sereno e profissional.",
    swatch: "oklch(0.585 0.2 254)",
  },
  {
    id: "amber",
    name: "Âmbar",
    tagline: "Aconchegante e amigável, ideal para pequenas equipes.",
    swatch: "oklch(0.745 0.16 65)",
  },
  {
    id: "rose",
    name: "Rosa",
    tagline: "Ousado e moderno para marcas, criadores e estilo de vida.",
